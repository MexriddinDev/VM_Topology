...
import type { Server as VmServer, VmLayer } from '../../types';
...
function normalizeVisualStatus(status: string | undefined): keyof typeof STATUS {
...
function InfraNode({ data, selected }: NodeProps<VmServer>) {
    ...
    const statusKey = normalizeVisualStatus((data as VmServer & { status?: string }).status);
